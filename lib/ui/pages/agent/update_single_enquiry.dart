...
class ExistingUpdateEnquiryPage extends StatefulWidget {
  var enquiryObject;
  ExistingUpdateEnquiryPage({Key key, this.enquiryObject}) : super(key: key);
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<ExistingUpdateEnquiryPage> {
