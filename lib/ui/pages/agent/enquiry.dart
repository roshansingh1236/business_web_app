...
class _HomePageState extends State<EnquiryPage> {
  ...
  _addPropertyRequest(BuildContext context) async {
    ...
    final msg1 = _date == "rent"
        ? jsonEncode({
            ...
            "property_id": showProperty == false
                ? []
                : _selectProperty != null
                    ? [
                        {
                          "id": _selectProperty,
                          "businessId": _selectBussinessId
                        }
                      ]
                    : []
          })
          ...
          Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                      left: 20.0, right: 10.0, top: _type == null ? 10 : 0),
                  child: DropdownButton(
                    isExpanded: true,
                    iconEnabledColor: Colors.black,
                    hint: _type == null
