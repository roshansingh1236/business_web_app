...
class _HomePageState extends State<PropertyPage> {
        ...
        ? jsonEncode({
            ...
            "owner_details": {
              ...
              "availability_startTime":
                  format2 != null ? format2.format(context) : null,
              "availability_endTime":
                  format3 != null ? format3.format(context) : null,
          ...
          Row(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Padding(
                      padding:
                          EdgeInsets.only(left: 10.0, right: 0.0, top: 10.0),
                      child: TextFormField(
          ...
          new Row(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Padding(
                      padding:
                          EdgeInsets.only(left: 8.0, right: 20.0, top: 0.0),
                      child: TextFormField(
                        textCapitalization: TextCapitalization.words,
                        keyboardType: TextInputType.text,
                        controller: floorno,
    ...
    return Column(children: [
      ...
      Row(
        ...
        children: [
          ...
          InkWell(
              onTap: () {
                amenityList.add({"amenity": details.text, "qty": qty1.text});
                setState(() {
                  qty1.clear();
                  details.clear();
                });
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        if (catalogue.length != 0) {
                          ...
                          Fluttertoast.showToast(
                              msg: "please add catalogue first!",
                              toastLength: Toast.LENGTH_SHORT,
                              gravity: ToastGravity.CENTER,
                              backgroundColor: Colors.red);
                        }
